+++
date = '2025-05-13T00:20:23+02:00'
draft = false
title = 'Securely Configure Vps'
tags=["vps", "security", "devops"]
+++
...
_If you do so, make sure that the user that you are going to use to log in also has the public key in /home/your_user_name/.ssh/authorized_keys file_
...
```shell
 Host linode_server   # choose a name for your server
    User    froggy    # the username of the user that we created
    Port 69
...
![](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)If you do not want to deal with config file, you can use [termius app](https://termius.com/linux) instead
